...
newnode=(struct snode*)malloc(sizeof(struct snode));  newnode->data=x;  
if(m==-1)  
{  
...
1.Insertion 2.Deletion 3.find 4.findprevious 5.print 6.exit  Enter the choice for operations  
1 
Enter the element to be inserted  
10  
Enter the element after which new to be inserted  -1  
Before Insertion  
-1-->After Insertion  
-1-->10-->  
1.Insertion 2.Deletion 3.find 4.findprevious 5.print 6.exit  Enter the choice for operations  
...
Enter the element to be inserted  
20  
Enter the element after which new to be inserted  10  
Before Insertion  
...
20  
Before Deletion  
-1-->10-->20-->After Deletion  
-1-->10-->  
1.Insertion 2.Deletion 3.find 4.findprevious 5.print 6.exit  Enter the choice for operations  
3  
enter the element to be searched  
10  
The element is present at the address 17503440  1.Insertion 2.Deletion 3.find 4.findprevious 5.print 6.exit  Enter the choice for operations  
4  
enter the element to be searched  
10  
The previous snode address of the element is 17503408  1.Insertion 2.Deletion 3.find 4.findprevious 5.print 6.exit  Enter the choice for operations  
6  
--------------------------------  
